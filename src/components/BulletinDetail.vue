<template>
    <div class="bulletin-detail-wrap">
      <div class="page">
          ...
          <div class="weui-tab">
            ...
            <div class="weui-tab__panel">
              ...
              <div class="weui-article">
                <h1 class="faq-detail-title">{{data.title}}</h1>
                <div>
                  <ul class="weui-media-box__info faq-detail-sub-title">
                    <li class="weui-media-box__info__meta">{{data.from}}</li>
                    <li class="weui-media-box__info__meta">{{data.create_time}}</li>
                  </ul>

                  <div class="faq-detail-answer" v-html="data.content"></div>
                </div>
              </div>
...
<script>
    ...
    export default {
      ...
      mounted () {
        ...
        axios.get('/static/bulletin/'+MapData.getUrlKey('id')+'.json').then(function (response) {
